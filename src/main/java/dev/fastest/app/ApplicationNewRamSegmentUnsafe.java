...
public class ApplicationNewRamSegmentUnsafe {

    private static final String FILE = "src/main/resources/measurements_1B.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(STR."Duration: \{end - start} ms.");
    }
    ...
    private static List<Segment> prepareSegments(long start, long end, int numberOfThreads) {
        ...
        long chunkSize = ((end - start) / numberOfThreads) - 1;
    ...
    public static HashMap<Index, Temperature> processChunk(long startLocation, long endLocation) {
        ...
        while (position < endLocation) {
            ...
            UNSAFE.copyMemory(null, numberStartPosition, temperatureBytes, Unsafe.ARRAY_BYTE_BASE_OFFSET + 1, temperatureBytes.length);
